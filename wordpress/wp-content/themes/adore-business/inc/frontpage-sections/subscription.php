...
$subscription				= get_theme_mod( 'adore_business_subscription_enable', false );
$subscription_image 		= get_theme_mod( 'adore_business_subscription_bg_image', '' );
$subscription_title 		= get_theme_mod( 'adore_business_subscription_title', __( 'Subscribe To Our Newsletter', 'adore-business') );
$subscription_description	= get_theme_mod( 'adore_business_subscription_description','' );
$subscription_btn_label		= get_theme_mod( 'adore_business_subscription_btn_label', __( 'SUBSCRIBE', 'adore-business') );
